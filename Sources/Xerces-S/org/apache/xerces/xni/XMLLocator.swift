...
extension org.apache.xerces.xni {
  ...
  public protocol XMLLocator {
    
    /// - Returns: the public identifier or nil
    func getPublicId() -> String?
    
    ///
    /// Returns the literal system identifier.
    ///
    /// - Returns: the literal system identifier or nil
    ///
    ...
    /// - Returns: the expanded system identifier or nil
    ...
    ///
    /// - Note: Note that, for a given entity, this value can only be considered final once
    ...
    ///
    /// - Returns: the encoding of the current entity or null
    ///
    ...
    ///
    /// - Returns: the XML version of the current entity or null
    ///
    func getXMLVersion() -> String
  }
}
